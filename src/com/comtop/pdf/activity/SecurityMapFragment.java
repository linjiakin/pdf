 ...
 * @author linyong
 */
public class SecurityMapFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.security_map, container, false);
	}
	...
	private void initTextView() {
		zyMapTextView = (TextView) getActivity().findViewById(R.id.security_map_zymap_id);
		byMapTextView = (TextView) getActivity().findViewById(R.id.security_map_bymap_id);
		dyMapTextView = (TextView) getActivity().findViewById(R.id.security_map_dymap_id);
		...
		humidityText = (TextView) getActivity().findViewById(R.id.security_map_humidity_id);
		temperatureText = (TextView) getActivity().findViewById(R.id.security_map_temperature_id);

		webView = (WebView) getActivity().findViewById(R.id.security_map_webview_id);
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				Toast.makeText(getActivity(), "平面图加载失败", Toast.LENGTH_SHORT).show();
			}
		});
	...
	private void initImageView() {
		ivCursor = (ImageView) getActivity().findViewById(R.id.security_map_cursor_id);
